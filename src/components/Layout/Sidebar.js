...
const SideNav = () => { return <div id="sidebar-menu">
                <ul className="metismenu" id="side-menu">
                            ...
                            <li>
                                <Link to="charger_status" className="waves-effect waves-light"><i className="ion ion-md-battery-charging"></i><span> Status </span></Link>
                            </li>
                            ...
                            <li>
                                <Link to="maps" className="waves-effect"><i className="ion ion-md-pin"></i><span> Map </span></Link>
                            </li>
                  {/*<li>*/}
